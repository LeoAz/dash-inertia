...
class ProductSalesExport implements FromCollection, ShouldAutoSize, WithColumnFormatting, WithHeadings, WithMapping, WithStyles, WithTitle
{
    public function __construct(protected $rows, protected $totals) {}

    public function title(): string
    {
        return 'Rapport Ventes Produits';
    }
